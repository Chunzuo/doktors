    ...
    <div class="container-fluid">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-6">
              ...
              <datepicker
                class="datepicker"
                :value="convertTimestampToString(doctor.expireDate)"
                id="expiredate"
              ></datepicker>
            </div>
          </div>
      ...
      <div class="card contact-card">
        <div class="card-body">
          ...
          <div class="row" v-if="doctorProfile.mapCenter">
            <div class="col-6">
              <div class="form-group">
...
export default {
  created() {
    this.$store.commit('updateSelectItem', 'UserProfile')
  },
  computed: {
    cityList() {
  ...
  methods: {
    ...
    async updateProfile() {
      ...
      this.doctor.expireDate = new Date($('#expiredate').val())
      await db
        .collection('Users')
        .doc(this.id)
        .update(this.user)
